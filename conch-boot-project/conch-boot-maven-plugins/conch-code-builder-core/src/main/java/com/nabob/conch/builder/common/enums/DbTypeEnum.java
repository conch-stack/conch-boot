package com.nabob.conch.builder.common.enums;
/**
 *  Copyright 2018 恒宇少年
 *
...
import com.nabob.conch.builder.core.database.impl.Db2DataBase;
import com.nabob.conch.builder.core.database.impl.MySqlDataBase;
import com.nabob.conch.builder.core.database.impl.OracleDataBase;
import com.nabob.conch.builder.core.database.impl.PostgreSqlDataBase;
import com.nabob.conch.builder.core.database.impl.SqlServerDataBase;
...
public enum DbTypeEnum {
     ...
     * MySQL数据库类型
     */
    MySQL("com.mysql.cj.jdbc.Driver", MySqlDataBase.class),
    /**
     * Db2数据库类型
     */
