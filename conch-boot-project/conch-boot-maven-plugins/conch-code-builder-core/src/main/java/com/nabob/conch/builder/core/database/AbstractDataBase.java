package com.nabob.conch.builder.core.database;
/**
 * Copyright 2018 恒宇少年
 * <p>
...
import com.nabob.conch.builder.common.enums.ErrorEnum;
import com.nabob.conch.builder.common.enums.TableMetaDataEnum;
import com.nabob.conch.builder.common.exception.CodeBuilderException;
...
import com.nabob.conch.builder.core.database.model.util.JavaTypeResolver;
import com.nabob.conch.builder.core.database.model.util.JdbcTypeResolver;
...
public abstract class AbstractDataBase implements DataBase {
    ...
    public Table getTable(String tableName) {
        ...
        try {
            ResultSet resultSet = getConnection().getMetaData().getTables(connection.getCatalog(), null, tableName, new String[]{"TABLE"});
            if (resultSet.next()) {
                tableBuilder
                        // 表名
                        .tableName(tableName)
    ...
    public List<Column> getColumns(String tableName) {
        ...
        try {
            // 获取列信息
            ResultSet resultSet = getConnection().getMetaData().getColumns(connection.getCatalog(), null, tableName, "%");
            while (resultSet.next()) {
    ...
    public List<Column> getPrimaryKeys(String tableName) {
        try {
            ...
            while (resultSet.next()) {
                ...
                String columnName = resultSet.getString(TableMetaDataEnum.COLUMN_NAME.getValue());
                // 获取主键列的详细信息
                ResultSet columnResultSet = connection.getMetaData().getColumns(connection.getCatalog(), null, tableName, columnName);
