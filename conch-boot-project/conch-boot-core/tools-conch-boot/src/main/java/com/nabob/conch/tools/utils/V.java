...
public class V {
    ...
    public static void securityCheck(String... paramValues) {
        ...
        for (String param : paramValues) {
            if (!V.isValidSqlParam(param)) {
                throw new RuntimeException("非法的参数: " + param);
            }
        }
    }
    ...
    private static class CardinalityHelper<O> {
        ...
        /**
         * Returns a {@link java.util.Map} mapping each unique element in the given
         * {@link java.util.Collection} to an {@link Integer} representing the number
         * of occurrences of that element in the {@link java.util.Collection}.
         * <p>
         * Only those elements present in the collection will appear as
         * keys in the map.
         * </p>
         *
         * @param <O>  the type of object in the returned {@link java.util.Map}. This is a super type of &lt;I&gt;.
