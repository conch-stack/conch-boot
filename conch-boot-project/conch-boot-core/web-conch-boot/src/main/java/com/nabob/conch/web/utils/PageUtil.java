...
import com.nabob.conch.web.response.page.PageResult;
...
public class PageUtil {
    ...
    public static PageRequest of(com.nabob.conch.web.response.page.Page page) {
        return PageRequest.of(page.getIndex() - 1, page.getSize());
    }


    public static PageRequest of(com.nabob.conch.web.response.page.Page page, Sort sort) {
