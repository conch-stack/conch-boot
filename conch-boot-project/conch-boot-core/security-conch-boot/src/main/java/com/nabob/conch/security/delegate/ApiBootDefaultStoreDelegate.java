...
public class ApiBootDefaultStoreDelegate implements ApiBootStoreDelegate {
     ...
     * @return 新对象
     */
    private <T> T wrapperOneResult(Class<T> resultClass, ResultSet rs) throws RuntimeException {
        ...
        try {
            ...
            throw new RuntimeException("Encapsulation result set object encounters exception information：" + e.getMessage(), e);
        }
