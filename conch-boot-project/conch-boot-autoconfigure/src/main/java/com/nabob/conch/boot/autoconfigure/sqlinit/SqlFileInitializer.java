 ...
 * SQL文件初始化处理类
 * <p>
 * 引入自：<a href="https://www.diboot.com/">DiBoot</a>
 *
...
public class SqlFileInitializer {
     ...
     * @return
     */
    public boolean extractAndExecuteSqls(Class inst, String sqlPath) {
     ...
     * @return
     */
    public boolean extractAndExecuteSqls(Class inst, String sqlPath, List<String> includes, List<String> excludes){
     ...
     * @return
     */
    public List<String> extractSqlStatements(List<String> sqlFileReadLines){
        // 解析SQL
     ...
     * @return
     */
    public String buildPureSqlStatement(String sqlStatement){
        return clearComments(sqlStatement);
    }
     ...
     * @return
     */
    public boolean executeMultipleUpdateSqls(List<String> sqlStatementList){
     ...
     * @return
     */
    public boolean executeMultipleUpdateSqlsWithTransaction(List<String> sqlStatementList) throws Exception {
        if(V.isEmpty(sqlStatementList)){
            return false;
        }
        // 获取SqlSessionFactory实例
     ...
     * @return
     */
    protected List<String> readLinesFromResource(Class inst, String sqlPath){
     ...
     * @return
     */
    public String clearComments(String inputSql){
     ...
     * @return
     */
    private String removeMultipleLineComments(String inputSql){
