...
@EnableConfigurationProperties({ConchMutilElasticsearchProperties.class})
@ConditionalOnProperty(value = "conch.data.elasticsearch.mutil.transport.enable", havingValue = "true", matchIfMissing = false)
public class ConchMutilElasticsearchAutoConfiguration {

    private final ConchMutilElasticsearchProperties properties;
    private ApplicationContext applicationContext;

    public ConchMutilElasticsearchAutoConfiguration(ConchMutilElasticsearchProperties properties, ApplicationContext applicationContext) throws Exception {
    ...
    private void init() throws Exception{
        Map<String, ConchMutilElasticsearchProperties.Instances> instances = this.properties.instances;
        for(Map.Entry<String, ConchMutilElasticsearchProperties.Instances> entry : instances.entrySet()) {
            String connectionName = entry.getKey();
            ConchMutilElasticsearchProperties.Instances instance = entry.getValue();
    ...
    public TransportClient elasticsearchClient(ConchMutilElasticsearchProperties.Instances instance) throws Exception {
    ...
    private Properties createProperties(ConchMutilElasticsearchProperties.Instances instance) {
