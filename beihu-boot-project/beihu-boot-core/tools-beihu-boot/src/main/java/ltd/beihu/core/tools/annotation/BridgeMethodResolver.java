package ltd.beihu.core.tools.annotation;

import ltd.beihu.core.tools.utils.ClassHelper;
import ltd.beihu.core.tools.utils.ReflectionHelper;
...
public abstract class BridgeMethodResolver {
    ...
    public static Method findBridgedMethod(Method bridgeMethod) {
        ...
        Method[] methods = ReflectionHelper.getAllDeclaredMethods(bridgeMethod.getDeclaringClass());
    ...
    private static Method findGenericDeclaration(Method bridgeMethod) {
        ...
        // Search interfaces.
        Class<?>[] interfaces = ClassHelper.getAllInterfacesForClass(bridgeMethod.getDeclaringClass());
    ...
    private static Method searchForMatch(Class<?> type, Method bridgeMethod) {
        return ReflectionHelper.findMethod(type, bridgeMethod.getName(), bridgeMethod.getParameterTypes());
    }
