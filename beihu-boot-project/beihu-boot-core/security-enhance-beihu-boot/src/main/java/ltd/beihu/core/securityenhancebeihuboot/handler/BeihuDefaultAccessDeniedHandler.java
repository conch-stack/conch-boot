 ...
 */
public class BeihuDefaultAccessDeniedHandler implements AccessDeniedHandler {
    /**
     * logger instance
     */
    static Logger logger = LoggerFactory.getLogger(BeihuDefaultAccessDeniedHandler.class);
